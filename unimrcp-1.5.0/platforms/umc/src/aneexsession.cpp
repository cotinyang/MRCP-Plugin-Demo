...
AneexRecogSession::~AneexRecogSession()
{
}
...
bool AneexRecogSession::OnSessionTerminate(mrcp_sig_status_code_e status)
{
	if(m_pRecogChannel)
	{
...
bool AneexRecogSession::OnChannelAdd(mrcp_channel_t* pMrcpChannel, mrcp_sig_status_code_e status)
{
...
bool AneexRecogSession::OnMessageReceive(mrcp_channel_t* pMrcpChannel, mrcp_message_t* pMrcpMessage)
{
...
bool AneexRecogSession::OnDefineGrammar(mrcp_channel_t* pMrcpChannel)
{
...
bool AneexRecogSession::StartRecognition(mrcp_channel_t* pMrcpChannel)
{
...
bool AneexRecogSession::ParseNLSMLResult(mrcp_message_t* pMrcpMessage)
{
...
FILE* AneexRecogSession::GetAudioIn(const mpf_codec_descriptor_t* pDescriptor, apr_pool_t* pool) const
{
