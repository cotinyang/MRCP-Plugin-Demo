...
#ifndef ANEEX_RECOG_HEADER_H
#define ANEEX_RECOG_HEADER_H
...
typedef enum {
	ANEEX_HEADER_CONFIDENCE_THRESHOLD,
	ANEEX_HEADER_SENSITIVITY_LEVEL,
	ANEEX_HEADER_SPEED_VS_ACCURACY,
	ANEEX_HEADER_N_BEST_LIST_LENGTH,
	ANEEX_HEADER_NO_INPUT_TIMEOUT,
	ANEEX_HEADER_RECOGNITION_TIMEOUT,
	ANEEX_HEADER_WAVEFORM_URI,
	ANEEX_HEADER_COMPLETION_CAUSE,
	ANEEX_HEADER_RECOGNIZER_CONTEXT_BLOCK,
	ANEEX_HEADER_START_INPUT_TIMERS,
	ANEEX_HEADER_SPEECH_COMPLETE_TIMEOUT,
	ANEEX_HEADER_SPEECH_INCOMPLETE_TIMEOUT,
	ANEEX_HEADER_DTMF_INTERDIGIT_TIMEOUT,
	ANEEX_HEADER_DTMF_TERM_TIMEOUT,
	ANEEX_HEADER_DTMF_TERM_CHAR,
	ANEEX_HEADER_FAILED_URI,
	ANEEX_HEADER_FAILED_URI_CAUSE,
	ANEEX_HEADER_SAVE_WAVEFORM,
	ANEEX_HEADER_NEW_AUDIO_CHANNEL,
	ANEEX_HEADER_SPEECH_LANGUAGE,

	/** Additional header fields for MRCP v2 */
	ANEEX_HEADER_INPUT_TYPE,
	ANEEX_HEADER_INPUT_WAVEFORM_URI,
	ANEEX_HEADER_COMPLETION_REASON,
	ANEEX_HEADER_MEDIA_TYPE,
	ANEEX_HEADER_VER_BUFFER_UTTERANCE,
	ANEEX_HEADER_RECOGNITION_MODE,
	ANEEX_HEADER_CANCEL_IF_QUEUE,
	ANEEX_HEADER_HOTWORD_MAX_DURATION,
	ANEEX_HEADER_HOTWORD_MIN_DURATION,
	ANEEX_HEADER_INTERPRET_TEXT,
	ANEEX_HEADER_DTMF_BUFFER_TIME,
	ANEEX_HEADER_CLEAR_DTMF_BUFFER,
	ANEEX_HEADER_EARLY_NO_MATCH,
	ANEEX_HEADER_NUM_MIN_CONSISTENT_PRONUNCIATIONS,
	ANEEX_HEADER_CONSISTENCY_THRESHOLD,
	ANEEX_HEADER_CLASH_THRESHOLD,
	ANEEX_HEADER_PERSONAL_GRAMMAR_URI,
	ANEEX_HEADER_ENROLL_UTTERANCE,
	ANEEX_HEADER_PHRASE_ID,
	ANEEX_HEADER_PHRASE_NL,
	ANEEX_HEADER_WEIGHT,
	ANEEX_HEADER_SAVE_BEST_WAVEFORM,
	ANEEX_HEADER_NEW_PHRASE_ID,
	ANEEX_HEADER_CONFUSABLE_PHRASES_URI,
	ANEEX_HEADER_ABORT_PHRASE_ENROLLMENT,

	ANEEX_HEADER_COUNT
} aneex_recognizer_header_id;


/** MRCP recognizer completion-cause  */
typedef enum {
	ANEEX_COMPLETION_CAUSE_SUCCESS                 = 0,
	ANEEX_COMPLETION_CAUSE_NO_MATCH                = 1,
	ANEEX_COMPLETION_CAUSE_NO_INPUT_TIMEOUT        = 2,
	ANEEX_COMPLETION_CAUSE_RECOGNITION_TIMEOUT     = 3,
	ANEEX_COMPLETION_CAUSE_GRAM_LOAD_FAILURE       = 4,
	ANEEX_COMPLETION_CAUSE_GRAM_COMP_FAILURE       = 5,
	ANEEX_COMPLETION_CAUSE_ERROR                   = 6,
	ANEEX_COMPLETION_CAUSE_SPEECH_TOO_EARLY        = 7,
	ANEEX_COMPLETION_CAUSE_TOO_MUCH_SPEECH_TIMEOUT = 8,
	ANEEX_COMPLETION_CAUSE_URI_FAILURE             = 9,
	ANEEX_COMPLETION_CAUSE_LANGUAGE_UNSUPPORTED    = 10,

	/** Additional completion-cause for MRCP v2 */
	ANEEX_COMPLETION_CAUSE_CANCELLED               = 11,
	ANEEX_COMPLETION_CAUSE_SEMANTICS_FAILURE       = 12,
	ANEEX_COMPLETION_CAUSE_PARTIAL_MATCH           = 13,
	ANEEX_COMPLETION_CAUSE_PARTIAL_MATCH_MAXTIME   = 14,
	ANEEX_COMPLETION_CAUSE_NO_MATCH_MAXTIME        = 15,
	ANEEX_COMPLETION_CAUSE_GRAM_DEFINITION_FAILURE = 16,

	ANEEX_COMPLETION_CAUSE_COUNT                   = 17,
	ANEEX_COMPLETION_CAUSE_UNKNOWN                 = ANEEX_COMPLETION_CAUSE_COUNT
} aneex_recog_completion_cause_e;



/** MRCP recognizer-header declaration */
typedef struct aneex_recog_header_t aneex_recog_header_t;

/** MRCP recognizer-header */
struct aneex_recog_header_t {
	...
	aneex_recog_completion_cause_e completion_cause;
